...
STAGE_GROUPS: dict[str, list[str]] = {
    ...
    "rl": ["run_rl_research", "mini_agents", "orchestrator_assistant", "specialist_scoreboard"],
...
def run_stage(stage: str, state: OrchestratorState, root: Path = ROOT) -> StageResult:
    ...
    if state.report_only and stage not in {"project_spine_audit", "build_dashboard", "run_rl_research", "mini_agents", "orchestrator_assistant", "specialist_scoreboard"}:
